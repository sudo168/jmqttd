...
COMMON_LIB_HOME=$DIR/../common-lib/*;export COMMON_LIB_HOME
CLASSPATH=$CLASSPATH:$ROOT_HOME:$RESOURCE_HOME:$DATA_HOME:$LIB_HOME:$COMMON_LIB_HOME:$MAPPER_HOME;export CLASSPATH
