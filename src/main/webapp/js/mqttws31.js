   ...
   ClientImpl.prototype.getTraceLog = function () {
    ...
    ClientImpl.prototype._doConnect = function (host, port) { 	        
        ...
        if (this.connectOptions.useSSL)
          wsurl = ["wss://", host, ":", port, this.connectOptions.context, "/mqtt"].join("");
        else
          wsurl = ["ws://", host, ":", port, this.connectOptions.context, "/mqtt"].join("");
    ...
    ClientImpl.prototype._requires_ack = function (wireMessage) {
        ...
        this._schedule_timeout(wireMessage);  
    };
    ...
    ClientImpl.prototype._on_socket_message = function (event) {
        ...
        switch(wireMessage.type) {
            ...
            case MESSAGE_TYPE.PUBACK:
            	...
            	this._schedule_timeout_cancel(wireMessage);
            	break;
            ...
            case MESSAGE_TYPE.PUBREC:
                ...
                if (sentMessage) {
                    ...
                    this._schedule_message(pubRelMessage);
                    this._schedule_timeout(pubRelMessage);
                }
                this._schedule_timeout_cancel(wireMessage);  
                break;
    ...
    ClientImpl.prototype._receivePublish = function (wireMessage) {
        switch(wireMessage.payloadMessage.qos) {
            ...
            case 2:
                ...
                this._schedule_timeout(pubRecMessage);
                break;
    ...
    ClientImpl.prototype._schedule_timeout = function (wireMessage) {
    	//(client, window, timeoutSeconds, action, args)
    	wireMessage.timeout = new Timeout(this,window,this.connectOptions.keepAliveInterval/3,function(wireMessage){
    		wireMessage.payloadMessage.duplicate = true;
    		this._socket_send(wireMessage);
        },[wireMessage]);
    	this._message_receive_timeout[wireMessage.messageIdentifier] = wireMessage ;
    }
    
    ClientImpl.prototype._schedule_timeout_cancel = function (wireMessage) {
    	var timeoutMessage = this._message_receive_timeout[wireMessage.messageIdentifier];
        if(timeoutMessage){
        	timeoutMessage.timeout.cancel();
        	delete this._message_receive_timeout[wireMessage.messageIdentifier];
        }
    }
    ...
    var Client = function (host, port, clientId) {
        ...
        if (typeof clientId !== "string" || clientIdLength < 1 | clientIdLength > 64)
